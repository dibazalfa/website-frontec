<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A cyclone is a type of dust collection equipment used to separate and remove particulate matter (such as dust, fines, and small particles) from the air before it is released into the environment. Cyclones utilize centrifugal force to separate heavier particles from the air stream, allowing for the collection of dust and ensuring cleaner, safer working conditions. They are often used in combination with other dust control systems, such as baghouses or filters.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/cyclone.png";
