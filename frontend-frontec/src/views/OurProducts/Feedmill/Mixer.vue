<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A mixer is a crucial piece of equipment used to blend various ingredients (such as grains, vitamins, minerals, and additives) into a uniform feed mixture. This ensures that the nutrients are evenly distributed throughout the feed, providing balanced nutrition to the animals. Mixers can handle both dry and wet ingredients, and they are essential for producing consistent, high-quality feed, whether it's for poultry, livestock, or aquaculture.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/Mixer.png";
