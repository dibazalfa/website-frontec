<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A Hammermill in the context of a feedmill is a critical piece of equipment used to crush, grind, or pulverize raw materials such as grains, oilseeds, and other feed ingredients into smaller particles. The goal of a hammermill in feedmill operations is to reduce the size of the raw material to facilitate further processing, such as mixing, pelleting, or compounding. This process enhances the digestibility of the feed, improves consistency, and ensures that the feed can be efficiently utilized by animals.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/Hammermill.png";
