    ...
    <main class="flex-1 flex flex-col md:flex-row">
      ...
      <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
        ...
        <div class="flex flex-col md:flex-row mt-12">
          ...
          >
            <p>
              An airlock is used to control airflow and maintain the efficiency of material handling systems. It is specifically designed to prevent the loss of air pressure when transferring materials between two different pressure zones, such as when feed ingredients are being moved through pneumatic conveying systems, dust control systems, or other processes requiring airflow management.
            </p>
          </div>
        </div>
...
import product from "@/assets/img/feedmill/air-lock.png";
