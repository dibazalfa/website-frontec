<template>
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            <div class="flex w-[382px] h-[378px] flex-shrink-0 shadow-lg">
              <p class="m-auto font-bold">
                  <img :src="product" alt="" class="object-contain w-[480px] h-[400px]" />
              </p>
            </div>
            <div
            ...
            >
              <p>
                A rotary distributor in the context of a feed mill is a piece of equipment used to distribute granular or powdered materials evenly across a surface or conveyor. It is commonly used in the feed production process, particularly in systems where bulk materials such as grains, meal, pellets, or additives need to be distributed uniformly to ensure consistent feed formulation. Rotary distributors play a crucial role in ensuring that ingredients are spread evenly, preventing segregation and maintaining the quality and consistency of the final feed product.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/rotary-distributor.png";
