<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A shifter is a type of material handling equipment used to separate, sort, and shift bulk materials based on their size, weight, or other physical characteristics. It is primarily used to segregate fine particles, impurities, or off-spec materials from the rest of the processed feed. The purpose of a shifter is to ensure that only the desired particles, typically of uniform size, move to the next stage of processing or packaging.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/shifter.png";
