<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A crumbler is a piece of equipment used in feed mills to break down pellets into smaller pieces, typically for use in starter feed for young animals or for animals that require smaller feed sizes. The crumbling process helps to adjust the size of the pellets to match the specific nutritional needs of different animal species and age groups. This is especially important in industries such as poultry farming, where chicks or piglets may need finely broken feed for easier consumption and digestion.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/crumbler.png";
