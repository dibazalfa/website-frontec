<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A conditioner is a crucial piece of equipment used in the pelletizing process to improve the quality and efficiency of the pellets produced. The main purpose of a conditioner is to prepare the raw material by adding moisture and heat, which enhances the physical properties of the feed before it enters the pellet mill for pelletizing.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/conditioner.png";
