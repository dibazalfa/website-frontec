<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A magnet separator in the context of a feed mill is a device used to remove ferrous metal contaminants (such as steel, iron, and other magnetic materials) from bulk materials, including grains, feed ingredients, and other processed products. The presence of metal contaminants in animal feed can lead to serious problems, including damage to equipment, compromised feed quality, and potential health risks to livestock. Therefore, a magnet separator plays a crucial role in maintaining the quality, safety, and efficiency of feed production processes.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/magnet-separator.png";
