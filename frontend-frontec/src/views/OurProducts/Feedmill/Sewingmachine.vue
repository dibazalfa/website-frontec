<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A sewing machine is used for sealing bags that contain feed products, ensuring the bags are securely closed for transport and storage. These machines are essential for finalizing the packaging process after the feed has been weighed and filled into bags. They help to maintain the integrity of the product and prevent spillage or contamination during handling and shipping.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/sewing-machine.jpg";
