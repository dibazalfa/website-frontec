<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A Drum Grader Cleaner is a piece of equipment used to clean and sort raw grains or other feed ingredients before they are processed into animal feed. Its primary function is to remove foreign particles, dust, debris, and impurities from the material, ensuring that only clean, high-quality grains are fed into the milling or pelleting process.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/drum-grader-cleaner.jpg";
