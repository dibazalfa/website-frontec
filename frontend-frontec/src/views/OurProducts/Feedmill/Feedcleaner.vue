<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A feed cleaner is a machine or system used to remove impurities, such as dust, dirt, small stones, foreign seeds, and other unwanted particles, from raw materials or finished feed products. Cleanliness and purity are crucial in feed production, as contaminants can affect the quality of the final product, damage equipment, and even harm animals if consumed. A feed cleaner is an essential component in ensuring that animal feed is safe, nutritious, and free from harmful substances.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/feed-cleaner.png";
