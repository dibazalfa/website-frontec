<template>
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            <div class="flex w-[382px] h-[378px] flex-shrink-0 shadow-lg">
              <p class="m-auto font-bold">
                  <img :src="product" alt="" class="object-contain w-[350px] h-[300px]" />
              </p>
            </div>
            <div
            ...
            >
              <p>
                A Cooler is an essential piece of equipment used to cool down feed after it has been processed, typically after the pelleting or conditioning stage. The cooling process is crucial to ensure that the feed maintains its quality, durability, and nutritional value while preventing mold growth, spoilage, or degradation.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/Cooler.png";
