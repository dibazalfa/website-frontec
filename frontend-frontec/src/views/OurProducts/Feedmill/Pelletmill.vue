<template>
      ...
      <main class="flex-1 flex flex-col md:flex-row">
        ...
        <section class="flex-1 p-4 mt-10 md:mt-0 md:ml-24 overflow-y-auto">
          ...
          <div class="flex flex-col md:flex-row mt-12">
            ...
            >
              <p>
                A pellet mill is a key piece of equipment in feed mills and other processing facilities used to produce pellets from various raw materials, such as grains, biomass, animal feed, or other organic materials. In the context of a feed mill, a pellet mill is designed to convert raw ground ingredients into uniform pellets, which are essential for animal nutrition and feed efficiency.
              </p>
            </div>
          </div>
  ...
  import product from "@/assets/img/feedmill/pelletmill.png";
