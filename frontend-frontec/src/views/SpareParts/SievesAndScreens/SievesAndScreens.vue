...
import product1 from "@/assets/img/spare-parts/sieve-cleaning-text.png";
import product2 from "@/assets/img/spare-parts/sieve-cleaners-text.png";
import product3 from "@/assets/img/spare-parts/pan-cleaners-text.png";
