...
import product1 from "@/assets/img/spare-parts/flat-surface-conveyor.png";
import product2 from "@/assets/img/spare-parts/patterned-conveyor.png";
import product3 from "@/assets/img/spare-parts/impact-bar-text.png";
