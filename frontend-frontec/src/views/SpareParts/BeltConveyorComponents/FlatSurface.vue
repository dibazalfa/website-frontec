        ...
        <div class="flex flex-col md:flex-row mt-12">
          ...
          >
            ...
            <ul class="list-disc mt-8 ml-6">
              <li>
                Prime is the true expert of conveyor belts with 40 years of
                experience manufacturing quality products. Prime offers general
                purpose conveyor belts, nylon, polyester, cotton and high
                temperature resistant belts.
              </li>
              <li>Comply with CEMA/RM, AS, GB standards.</li>
            </ul>
          </div>
        </div>
        ...
        <div class="flex flex-col mt-10">
          ...
          >
            ...
            <router-link to="/patterned-conveyor">
              <p class="text-[18px] px-4 py-8 border-b border-black">Patterned Conveyor</p>
            </router-link>
...
import product from "@/assets/img/spare-parts/flat-surface.png";
import spec from "@/assets/img/spare-parts/flat-surface-spec.png";
