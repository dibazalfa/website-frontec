        ...
        <div class="flex flex-col md:flex-row mt-12">
          ...
          >
            ...
            <ul class="list-disc mt-8 ml-6">
              <li>
                The carcass is made from low shrink, high crimpness dipped
                rubber Terylene fabric, it is the most popular rubber belt being
                used in grain and food industry due to moderate oil resistant
                and anti-static formula adopted.
              </li>
            </ul>
          </div>
        </div>
...
import rubber from "@/assets/img/spare-parts/rubber.png";
