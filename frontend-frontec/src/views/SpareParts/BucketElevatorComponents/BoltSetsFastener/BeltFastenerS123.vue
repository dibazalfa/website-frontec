        ...
        <div class="flex flex-col md:flex-row mt-12">
          ...
          >
            ...
            <ul class="list-disc mt-8 ml-6">
              <li>
                S1 is a whole press molding, S2 is made of 2 S1 single pieces
                welded together, S3 is the reinforced version of S2, with good
                dimensional consistency and high interchangeability accuracy.
              </li>
              <li>
                High combination capability for different width lifting belts
              </li>
